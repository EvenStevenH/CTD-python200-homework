...
# Both faithfulness and relevancy scores did not change between the queries; faithfulness stayed at 0.0, while relevancy stayed at 1.0. The first query was more likely to receive higher faithfulness and relevancy scores because the requested information existed in the BrightLeaf documents. The second, clearly lower quality query was more likely to produce lower scores because the documents did not contain information needed to answer it. The evaluators would typically reflect this difference in response quality.
